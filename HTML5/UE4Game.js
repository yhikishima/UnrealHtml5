...
var STACK_BASE = 17315712, STACKTOP = STACK_BASE, STACK_MAX = 22558592, DYNAMIC_BASE = 22558592, DYNAMICTOP_PTR = 17314720;
...
if (!ENVIRONMENT_IS_PTHREAD) {
 memoryInitializer = "UE4Game.js.mem";
}

var tempDoublePtr;

if (!ENVIRONMENT_IS_PTHREAD) tempDoublePtr = 17315696;
...
var __main_thread_futex_wait_address = 17315680;
...
var PThread = {
 ...
 initMainThreadBlock: function() {
  ...
  PThread.mainThreadBlock = 17314896;
 ...
 createNewWorkers: function(numWorkers) {
  if (typeof SharedArrayBuffer === "undefined") return [];
  var pthreadMainJs = "UE4Game.worker.js";
...
var ___tm_timezone = (stringToUTF8("GMT", 17314800, 4), 17314800);
